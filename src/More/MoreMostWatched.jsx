...
const MoreMostWatched = () => {
    ...
    useEffect(() => {
        getmovies7(`https://api.themoviedb.org/3/movie/top_rated?language=en-US&page=${pageCount}&api_key=c52e8c9749d8e16e1e525525da148b63`);
    },[pageCount]);
    ...
    return (
        ...
        <br/><br/><br/>
        <h2 className="title">Our Top Rated</h2>
        <br/><br/>
        <div className="row">
          {discover.map((movie)=>
...
export default MoreMostWatched
